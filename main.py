...
import sys  # We will use sys.exit is used to exit the program
import pygame
...
# icon of our game
icon = pygame.image.load('gallery/sprites/icon_2.png')
...
def mainGame():
    ...
    while True:
        ...
        # Add a new pipe when the first is about ot cross the leftmost part of the SCREEN
...
if __name__ == "__main__":
    # This will be the main point from where our game will Strt

    pygame.init()  # Initialize all pygame's modules
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption("FlappyBird by BugBusters.!")
